...
AddEventHandler("dc_weedroll:rollpaper", function()
    ...
    if not IsPedInAnyVehicle(player) then
        local Paper = CreateObject(GetHashKey('dc_rollpaper'), playcoords.x, playcoords.y, playcoords.z, false, true, false)
        local Bud = CreateObject(GetHashKey('dc_weednug'), playcoords.x, playcoords.y, playcoords.z, false, true, false)
        local Joint = CreateObject(GetHashKey('p_cs_joint_02'), playcoords.x, playcoords.y, playcoords.z, false, true, false)
        ...
        DeleteObject(Bud)
        DeleteObject(Paper)
        Paper = CreateObject(GetHashKey('dc_rollpaper'), playcoords.x, playcoords.y, playcoords.z, false, true, false)
